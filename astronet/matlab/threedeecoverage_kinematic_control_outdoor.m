...
while coverror(1)>0.05;
   %tic
    ...
    x_1_UKF_debug(t_count)=x_1;
    x_2_UKF_debug(t_count)=x_2;
    y_1_UKF_debug(t_count)=y_1;
    y_2_UKF_debug(t_count)=y_2;
    z_1_UKF_debug(t_count)=z_1;
    z_2_UKF_debug(t_count)=z_2;
    qw_1_UKF_debug(t_count)=qw_1;
    qw_2_UKF_debug(t_count)=qw_2;
    qx_1_UKF_debug(t_count)=qx_1;
    qx_2_UKF_debug(t_count)=qx_2;
    qy_1_UKF_debug(t_count)=qy_1;
    qy_2_UKF_debug(t_count)=qy_2;
    qz_1_UKF_debug(t_count)=qz_1;
    qz_2_UKF_debug(t_count)=qz_2;
    ax_1_UKF_debug(t_count)=ax_1;
    ax_2_UKF_debug(t_count)=ax_2;
    ay_1_UKF_debug(t_count)=ay_1;
    ay_2_UKF_debug(t_count)=ay_2;
    az_1_UKF_debug(t_count)=az_1;
    az_2_UKF_debug(t_count)=az_2;
    wx_1_UKF_debug(t_count)=wx_1;
    wx_2_UKF_debug(t_count)=wx_2;
    wy_1_UKF_debug(t_count)=wy_1;
    wy_2_UKF_debug(t_count)=wy_2;
    wz_1_UKF_debug(t_count)=wz_1;
    wz_2_UKF_debug(t_count)=wz_2;
    pos_cov_1_UKF_debug(t_count,:)=pos_cov_1;
    pos_cov_2_UKF_debug(t_count,:)=pos_cov_2;
    accel_cov_1_UKF_debug(t_count,:)=accel_cov_1;
    accel_cov_2_UKF_debug(t_count,:)=accel_cov_2;
    angular_cov_1_UKF_debug(t_count,:)=angular_cov_1;
    angular_cov_2_UKF_debug(t_count,:)=angular_cov_2;
    orient_cov_1_UKF_debug(t_count,:)=orient_cov_1;
    orient_cov_2_UKF_debug(t_count,:)=orient_cov_2;
   x_i(1,t_count) = x_1*(200/25)+100; % convert to MATLAB coordinates;
    x_i(2,t_count) = x_2*(200/25)+100; % convert to MATLAB coordinates;
    y_i(1,t_count) = y_1*(200/25)+100;
    y_i(2,t_count) = y_2*(200/25)+100;
    z_i(1,t_count) = z_1*(100/10)-100;
    z_i(2,t_count) = z_2*(100/10)-100;
    lat_save(1,t_count)=lat_1;
    lat_save(2,t_count)=lat_2;
    long_save(1,t_count)=long_1;
    long_save(2,t_count)=long_2;
    alt_save(1,t_count)=alt_1;
    alt_save(2,t_count)=alt_2;
...
Current=[x_i(2,t_count),y_i(2,t_count),z_i(2,t_count) yaw_i(2,t_count) ui(2) vi(2)];
Current=[wx_2 wy_2 wz_2]
%[volt_1,volt_2]
%ui
%toc
drawnow
