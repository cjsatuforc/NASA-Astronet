...
quad_list = {'/hbirdb/gazebo/set_model_state' '/hbirddg/gazebo/set_model_state' '/vicon/William/William' '/vicon/Left_Arm/Left_Arm' '/vicon/Right_Arm/Right_Arm'};
...
vicon_sub(1) = rossubscriber(quad_list{1},'gazebo_msgs/ModelState',viconCallback_list{1});
vicon_sub(2) = rossubscriber(quad_list{2},'gazebo_msgs/ModelState',viconCallback_list{2});
