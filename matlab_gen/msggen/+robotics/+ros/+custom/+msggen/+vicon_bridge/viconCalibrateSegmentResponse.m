classdef viconCalibrateSegmentResponse < robotics.ros.Message
    %viconCalibrateSegmentResponse MATLAB implementation of vicon_bridge/viconCalibrateSegmentResponse
    ...
    properties (Constant)
        MessageType = 'vicon_bridge/viconCalibrateSegmentResponse' % The ROS message type
    end
    
    properties (Constant, Hidden)
        MD5Checksum = 'fd8b451f9e0c65ec25938e0acbd102d7' % The MD5 Checksum of the message definition
    end
    ...
    properties (Constant, Hidden)
        PropertyList = {'Pose', 'Status', 'Success'} % List of non-constant message properties
        ROSPropertyList = {'pose', 'status', 'success'} % List of non-constant ROS message properties
    end
    
    methods
        function obj = viconCalibrateSegmentResponse(msg)
            %viconCalibrateSegmentResponse Construct the message object viconCalibrateSegmentResponse
        ...
        function set.Success(obj, success)
            ...
            validateattributes(success, {'logical', 'numeric'}, {'nonempty', 'scalar'}, 'viconCalibrateSegmentResponse', 'Success');
        ...
        function set.Status(obj, status)
            ...
            validateattributes(status, {'char'}, {}, 'viconCalibrateSegmentResponse', 'Status');
        ...
        function set.Pose(obj, pose)
            ...
            validateattributes(pose, {obj.GeometryMsgsPoseStampedClass}, {'nonempty', 'scalar'}, 'viconCalibrateSegmentResponse', 'Pose');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.vicon_bridge.viconCalibrateSegmentResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.vicon_bridge.viconCalibrateSegmentResponse;
            obj.reload(strObj);
        end
    end
end
