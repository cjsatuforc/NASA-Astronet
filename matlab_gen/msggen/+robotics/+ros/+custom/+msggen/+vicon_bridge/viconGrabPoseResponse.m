classdef viconGrabPoseResponse < robotics.ros.Message
    %viconGrabPoseResponse MATLAB implementation of vicon_bridge/viconGrabPoseResponse
    ...
    properties (Constant)
        MessageType = 'vicon_bridge/viconGrabPoseResponse' % The ROS message type
    end
    
    properties (Constant, Hidden)
        MD5Checksum = '236213ed6979c1ab1c49bd1bc04ace9e' % The MD5 Checksum of the message definition
    end
    ...
    properties (Constant, Hidden)
        PropertyList = {'Pose', 'Success'} % List of non-constant message properties
        ROSPropertyList = {'pose', 'success'} % List of non-constant ROS message properties
    end
    
    methods
        function obj = viconGrabPoseResponse(msg)
            %viconGrabPoseResponse Construct the message object viconGrabPoseResponse
        ...
        function set.Success(obj, success)
            ...
            validateattributes(success, {'logical', 'numeric'}, {'nonempty', 'scalar'}, 'viconGrabPoseResponse', 'Success');
        ...
        function set.Pose(obj, pose)
            ...
            validateattributes(pose, {obj.GeometryMsgsPoseStampedClass}, {'nonempty', 'scalar'}, 'viconGrabPoseResponse', 'Pose');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.vicon_bridge.viconGrabPoseResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.vicon_bridge.viconGrabPoseResponse;
            obj.reload(strObj);
        end
    end
end
