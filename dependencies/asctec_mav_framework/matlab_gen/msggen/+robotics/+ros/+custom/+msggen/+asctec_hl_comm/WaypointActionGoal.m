classdef WaypointActionGoal < robotics.ros.Message
    %WaypointActionGoal MATLAB implementation of asctec_hl_comm/WaypointActionGoal
    ...
    properties (Constant)
        MessageType = 'asctec_hl_comm/WaypointActionGoal' % The ROS message type
    end
    
    properties (Constant, Hidden)
        MD5Checksum = 'fa35b0fbc9b50aade196a7f44b283346' % The MD5 Checksum of the message definition
    end
    ...
    properties (Constant, Access = protected)
        ...
        AsctecHlCommWaypointGoalClass = robotics.ros.msg.internal.MessageFactory.getClassForType('asctec_hl_comm/WaypointGoal') % Dispatch to MATLAB class for message type asctec_hl_comm/WaypointGoal
    ...
    methods
        function obj = WaypointActionGoal(msg)
            %WaypointActionGoal Construct the message object WaypointActionGoal
        ...
        function set.Header(obj, header)
            ...
            validateattributes(header, {obj.StdMsgsHeaderClass}, {'nonempty', 'scalar'}, 'WaypointActionGoal', 'Header');
        ...
        function set.GoalId(obj, goalid)
            ...
            validateattributes(goalid, {obj.ActionlibMsgsGoalIDClass}, {'nonempty', 'scalar'}, 'WaypointActionGoal', 'GoalId');
        ...
        function goal = get.Goal(obj)
            ...
            if isempty(obj.Cache.Goal)
                obj.Cache.Goal = feval(obj.AsctecHlCommWaypointGoalClass, obj.JavaMessage.getGoal);
            end
            goal = obj.Cache.Goal;
        end
        ...
        function set.Goal(obj, goal)
            ...
            validateattributes(goal, {obj.AsctecHlCommWaypointGoalClass}, {'nonempty', 'scalar'}, 'WaypointActionGoal', 'Goal');
    ...
    methods (Access = protected)
        ...
        function reload(obj, strObj)
            ...
            obj.Goal = feval([obj.AsctecHlCommWaypointGoalClass '.loadobj'], strObj.Goal);
        end
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.asctec_hl_comm.WaypointActionGoal.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.asctec_hl_comm.WaypointActionGoal;
            obj.reload(strObj);
        end
    end
end
